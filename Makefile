...
help:
	...
	@echo "make upgrade-all                          # upgrade monitoring, hiresense, recruiter-report (staging+prod)"
...
upgrade-all: upgrade-monitoring upgrade-hiresense upgrade-recruiter-report-staging upgrade-recruiter-report-prod
